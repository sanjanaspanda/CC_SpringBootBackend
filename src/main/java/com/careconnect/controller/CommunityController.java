...
public class CommunityController {
  ...
  @PostMapping("/{id}/join")
  public ResponseEntity<Community> joinCommunity(@PathVariable String id, @RequestParam String userId) {
    Community updatedCommunity = communityService.addUserToCommunity(id, userId);
    return new ResponseEntity<>(updatedCommunity, HttpStatus.OK);
  }

  @PostMapping("/{id}/leave")
  public ResponseEntity<Community> leaveCommunity(@PathVariable String id, @RequestParam String userId) {
    Community updatedCommunity = communityService.removeUserFromCommunity(id, userId);
    return new ResponseEntity<>(updatedCommunity, HttpStatus.OK);
  }
